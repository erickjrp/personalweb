<!-- Modal -->
<div class="modal modal-fullscreen fade" id="logoman" tabindex="-1" role="dialog" aria-labelledby="logoman">
      ...
      <div class="modal-body">
        ...
        <div class="row fila_imagen_modal">
          ...
          <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            ...
            <div id="carrusel-logoman" class="carousel slide" data-ride="carousel" data-interval="false">
              <!-- Indicators -->
              <ol class="carousel-indicators">
                <li data-target="#carrusel-logoman" data-slide-to="0" class="active"></li>
                <li data-target="#carrusel-logoman" data-slide-to="1"></li>
              ...
              <!-- Controls -->
              <a class="left carousel-control" href="#carrusel-logoman" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
              </a>
              <a class="right carousel-control" href="#carrusel-logoman" role="button" data-slide="next">
